...
class UserCrudController extends CrudController
{
    ...
    protected function setupListOperation()
    {
        ...
        CRUD::column('ine')->label('INE');
        CRUD::column('date_naissance');
        CRUD::column('telephone');
        CRUD::column('email');
        // CRUD::column('photo');
        // CRUD::column('password');
        CRUD::column('admin')->type('check')->label('Membre commission');
        CRUD::column('enabled')->type('check')->label('Compte Actif');
    ...
    protected function setupCreateOperation()
    {
        ...
        CRUD::field('name')->label('Nom complet');
        CRUD::field('ine')->label('INE');
